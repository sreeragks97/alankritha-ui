  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-xl text-white">
        ...
        <p className="mt-3 max-w-lg text-sm leading-6 text-[#fff7e3] sm:mt-4 sm:leading-7 sm:text-base">{subtitle}</p>
        <Link
          href={ctaHref}
          className="mt-6 inline-flex min-h-11 items-center rounded-full bg-[#f4ddb0] px-5 py-2.5 text-sm font-semibold text-[#3e2f16] shadow-[0_14px_30px_rgba(23,16,8,0.33)] hover:-translate-y-0.5 hover:bg-[#f1d398] sm:mt-7"
        >
          {ctaText}
        </Link>
      </div>
